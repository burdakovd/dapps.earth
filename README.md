...
Deployment transparency: [Integrity logs](https://dapps.earth/integrity/), [CI credentials](https://dapps.earth/travis-credentials/), [geth sync status](https://dapps.earth/geth/)
