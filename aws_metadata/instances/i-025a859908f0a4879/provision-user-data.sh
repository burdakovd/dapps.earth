#!/bin/bash -xe
export INIT_SCRIPT_SOURCE="curl --silent --fail 'https://raw.githubusercontent.com/burdakovd/dapps.earth/6827e5589c91258d890be8b6e81b02bb96ec75fe/scripts/initialize-instance.sh'"
