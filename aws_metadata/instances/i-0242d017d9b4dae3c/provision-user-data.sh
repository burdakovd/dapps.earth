#!/bin/bash -xe
export INIT_SCRIPT_SOURCE="curl --silent --fail 'https://raw.githubusercontent.com/burdakovd/dapps.earth/84efa41fcee05aa5a268810e89f892776bfa455d/scripts/initialize-instance.sh'"
