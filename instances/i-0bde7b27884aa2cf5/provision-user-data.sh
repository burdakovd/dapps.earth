#!/bin/bash -xe
export INIT_SCRIPT_SOURCE="curl --silent --fail 'https://raw.githubusercontent.com/burdakovd/dapps.earth/bb487b840a429a5211903aa8fbd2c65ddb9cddef/scripts/initialize-instance.sh'"
